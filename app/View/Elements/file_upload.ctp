...
<?php echo $this->Html->script('http://blueimp.github.com/JavaScript-Load-Image/load-image.min.js', array('block' => 'scriptBottom'));?>
<?php echo $this->Html->script('http://blueimp.github.com/JavaScript-Canvas-to-Blob/canvas-to-blob.min.js', array('block' => 'scriptBottom'));?>
<?php echo $this->Html->script('blueimp/js/locale.js', array('block' => 'scriptBottom'));?>

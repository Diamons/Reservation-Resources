...
?>
	<tr<?php echo $class;?>>
		...
		<td class="actions">
		  ...
		  <?php echo $this->Html->link('Delete', array('action' => 'delete', $instantPaymentNotification['InstantPaymentNotification']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $instantPaymentNotification['InstantPaymentNotification']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
</table>
